...
|------------------------------|--------------------|---------------|-------------------|---------------|
| Operational Monitoring of IBM Cloud® Code Engine workload | Monitor app health to detect issues that might impact the availability of the app. | * IBM Cloud Monitoring \n * BYO Monitoring Tool | IBM Cloud Monitoring  | IBM Cloud Monitoring is integrated with IBM Cloud® Code Engine.  IBM Cloud® Code Engine forwards selected [metrics](/docs/codeengine?topic=codeengine-monitor#metrics-by-plan) about the workloads to IBM Cloud Monitoring. |

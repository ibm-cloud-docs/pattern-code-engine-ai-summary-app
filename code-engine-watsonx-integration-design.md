...
![Diagram showing integration with watsonx.ai](images/watsonx-codeengine-integration-diagram.svg){: caption="Integrating watsonx.ai with {{site.data.keyword.codeengineshort}}" caption-side="bottom"}

...
![Network Diagram](./code-engine-app-pattern-arch-diagram.svg){: caption="Figure 1. AI Summarization Using Highly Resilient Serverless Architecture in IBM Cloud® solution architecture" caption-side="bottom"}
...
![Design Scope](./heat-map-template-codeengine-app.svg){: caption="Figure 2. AI Summarization Using Highly Resilient Serverless Architecture in IBM Cloud® design scope" caption-side="bottom"}
